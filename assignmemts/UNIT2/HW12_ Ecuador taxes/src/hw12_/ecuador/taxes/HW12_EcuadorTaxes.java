 ...
 */
public class HW12_EcuadorTaxes {
    ...
    do {
        System.out.println("==============================");
        System.out.println("========* SRI TAXES *========");
        System.out.println("1. IVA (VAT)");//IVA del Ecuador 12%
        System.out.println("2. Income Tax");//Impuesto sobre la renta
        System.out.println("3. Currency Outflow Tax");//Impuesto a la Salida de Divisas
        System.out.println("* Press 0 (Zero) to Exit *");//Presione 0 (cero) para salir
        System.out.println("===============================");
    ...
    switch (option) {
        case 1:
           ...
           float VATValue;
            ...
            System.out.println(" Enter the total value of 1st necessity" + " produts (Tuna, Rice, Oil, Sugar)");
        ...
        case 2:
           ...
           float incomeTax = 0.0F;
             ...
             sumDeducible = (float) (sumHomeDeducibles(homeDeducible) + sumDressDeducibles(dressDeducible) + sumFoodDeducibles(foodDeducible) + computeEducation(educationDeducible) + computeHealth(healthDeducible));
